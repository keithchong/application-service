...
func TestGetMappedComponent(t *testing.T) {
	...
	}{
		{
			...
			component: appstudiov1alpha1.Component{
				...
				Spec: appstudiov1alpha1.ComponentSpec{
					...
					Secret:            "Secret",
					ReleaseStrategies: []string{"release1", "release2"},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.True(t, reflect.DeepEqual(tt.want.Spec.ReleaseStrategies, mappedComponent.Spec.ReleaseStrategies), "Expected Spec.ReleaseStrategies: %s, is different than actual: %s", tt.want.Spec.ReleaseStrategies, mappedComponent.Spec.ReleaseStrategies)
